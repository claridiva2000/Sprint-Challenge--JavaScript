...
zooAnimals.forEach(function(zooAnimal){
  animalNames.push(zooAnimal.animal_name + ', ' + zooAnimal.scientific_name);
})
...
zooAnimals.filter(function(zooAnimal){
...
*/
const populationTotal = zooAnimals.reduce((accumulator, zooAnimal) =>{
